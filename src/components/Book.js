    ...
    return (
        <div className="book">
            <div className="book-top">
                ...
                <div className="book-cover" style={{ width: 128, height: 193, backgroundImage:book.imageLinks.thumbnail !== undefined? `url(${book.imageLinks.thumbnail})`:`` }}></div>
            ...
            {book.authors.map(b => (
                            ...
                            <div className="book-authors">{b}</div>
